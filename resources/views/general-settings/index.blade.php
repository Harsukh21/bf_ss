            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        ...
                        <form action="{{ route('general-settings.optimize') }}" method="POST" class="mt-4">
                            @csrf
                            <button type="submit" class="bg-green-600 dark:bg-green-700 text-white px-4 py-2 rounded-lg hover:bg-green-700 dark:hover:bg-green-800 transition-colors">
                                Optimize Now
                            </button>
                        </form>
                    </div>
