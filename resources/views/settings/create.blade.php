    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Setting</h1>
            ...
            <form method="POST" action="{{ route('settings.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" 
                               ...
                               value="1"
                               {{ old('send_freeze_telegram') ? 'checked' : '' }}
                ...
                <div class="flex items-center justify-end space-x-4 pt-2">
                    ...
                    <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">Create Setting</button>
                </div>
            </form>
        </div>
    </div>
