        ...
        @auth
            <div class="px-4 py-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <form action="{{ route('logout') }}" method="POST" id="sidebarLogoutForm">
                    @csrf
                    <button type="button" onclick="handleSidebarLogout()" class="w-full flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 transition-all duration-300 ease-in-out">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
