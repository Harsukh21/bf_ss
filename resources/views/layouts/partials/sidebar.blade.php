    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <div class="mt-8">
                ...
                <!-- Markets Dropdown -->
                <div class="relative">
                    <button onclick="toggleDropdown('markets')" class="flex items-center justify-between w-full px-4 py-3 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="markets-dropdown" class="hidden space-y-1 ml-4">
            ...
            <div class="mt-6">
                ...
                <div class="relative">
                    @php
                        $isSettingsActive = request()->routeIs('system-logs.*') || request()->routeIs('performance.*');
                    ...
                    <div id="settings-dropdown" class="mt-2 space-y-1 ml-4 {{ $isSettingsActive ? '' : 'hidden' }}">
                        <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-600 dark:text-gray-400 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
