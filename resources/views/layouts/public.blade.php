        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="#" 
                       class="bg-gradient-to-r from-primary-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-primary-700 hover:to-purple-700 transition-all font-medium">
                        Sign Up
                    </a>
                </div>
            </div>
    ...
    <footer class="bg-gray-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <!-- Resources -->
                <div>
                    <h4 class="text-sm font-semibold mb-4 text-gray-300">Resources</h4>
                    <ul class="space-y-2 text-sm text-gray-400">
                ...
                <!-- Connect -->
                <div>
                    <h4 class="text-sm font-semibold mb-4 text-gray-300">Connect</h4>
