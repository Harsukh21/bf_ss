...
<div class="px-4 py-6 sm:px-0">
    <div class="max-w-7xl mx-auto">
        ...
        @if(session('success'))
            <div class="alert mb-6 bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-md transition-opacity duration-300">
                <div class="flex">
                    ...
                    <button type="button" class="alert-close-btn flex-shrink-0 text-green-400 hover:text-green-600">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900">1</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900">Just now</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900">Active</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <!-- Welcome Message -->
        <div class="bg-gradient-to-r from-primary-600 to-purple-600 rounded-lg shadow-lg p-8 mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-white mb-2">Welcome to Your Dashboard! 🎉</h2>
                    <p class="text-primary-100">
                        You're successfully logged in. Start managing your application from here.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a href="#" class="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xs text-gray-500">Add new content</p>
                        </div>
                    </a>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-5">
                ...
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started by exploring the dashboard.</p>
                </div>
            </div>
        </div>
    </div>
