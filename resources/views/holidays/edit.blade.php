...
<div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">Update holiday details</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('holidays.update', $holiday) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3"
                    class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">{{ old('description', $holiday->description) }}</textarea>
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Repeats every year on the same date</p>
                    </div>
                </label>
            </div>
