...
<div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Add a new holiday to the calendar</p>
        </div>
    </div>
            ...
            <div class="px-4 py-5 sm:p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" placeholder="Optional description..."
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-gray-100">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                    <label class="flex items-start gap-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Repeats every year on the same date (e.g. national holidays)</p>
                        </div>
                    </label>
                </div>
            </div>
