...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Total Markets</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Total Volume</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($summary['total_volume'], 2) }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Average Volume</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($summary['avg_volume'], 2) }}</p>
                </div>
