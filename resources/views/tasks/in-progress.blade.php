...
@section('title', 'In Progress Tasks')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">In Progress Tasks</h1>
                <p class="text-sm md:text-base text-gray-600 dark:text-gray-400">View and manage tasks currently in progress.</p>
            </div>
        ...
        @else
            <div class="flex items-center justify-center py-12">
                <div class="text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tasks that are currently being worked on will appear here.</p>
                </div>
            </div>
        @endif
    </div>
...
@include('tasks.partials.filter-drawer', [
    'filterAction' => route('tasks.in-progress'),
    'clearRoute' => route('tasks.in-progress'),
    'showStatus' => false,
])
